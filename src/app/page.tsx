  ...
  return (
    <>
      ...
      >
        ...
        <div>
          Here you will be able to view a plethora of student information,
          upload class and assignment marks, gain insights into student
          performance through the basic and also the enhanced analytics view to
          better make student outcome decisions. You can view student
          circumstances around assignments, exams and other marks which will
